...
<head>
    ...
    <title>Lara-car - Car Rental Service HTML Template</title>
    <!-- site favicon -->
    ...
    <!-- datepicker css link -->
    <link rel="stylesheet" href="{{asset('frontend/assets/css/datepicker.min.css')}}">
    <!-- wickedpicker css link -->
    <link rel="stylesheet" href="{{asset('frontend/assets/css/wickedpicker.min.css')}}">
    <!-- jquery ui css link -->
...
<body>
        ...
        <div class="header-bottom">
            <div class="container">
                <nav class="navbar navbar-expand-lg p-0">
                    <a class="site-logo site-title" href="index.html"><img src="assets/images/logo1.png"
                    ...
                    <div class="col-lg-4 col-sm-8">
                        <div class="footer-widget widget-about">
                            <div class="widget-about-content">
                                <a href="index.html" class="footer-logo"><img src="assets/images/logo-footer.png"
                                        alt="logo"></a>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-sm-6">
                        <ul class="payment-method d-flex justify-content-end">
                            <li>We accept</li>
                            <li><img src="{{asset('frontend/assets/images/money-method/1.png')}}" alt="image"></li>
                            <li><img src="{{asset('frontend/assets/images/money-method/2.png')}}" alt="image"></li>
                            <li><img src="{{asset('frontend/assets/images/money-method/3.png')}}" alt="image"></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!-- lightcase js link -->
    <script src="{{asset('frondend/assets/js/lightcase.js')}}"></script>
    <!-- wow js link -->
    ...
    <script src="{{asset('frontend/assets/js/wickedpicker.min.js')}}"></script>
